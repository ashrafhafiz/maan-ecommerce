            ...
            <div class="az-header-right">
                ...
                <div class="dropdown az-header-notification">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="az-notification-list">
                            <div class="media new">
                                <div class="az-img-user"><img
                                        src="{{ asset('assets/dashboard/img/faces/face2.jpg') }}" alt="">
                                </div>
                            ...
                            <div class="media new">
                                <div class="az-img-user online"><img
                                        src="{{ asset('assets/dashboard/img/faces/face3.jpg') }}" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media">
                                <div class="az-img-user"><img
                                        src="{{ asset('assets/dashboard/img/faces/face4.jpg') }}" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media">
                                <div class="az-img-user"><img
                                        src="{{ asset('assets/dashboard/img/faces/face5.jpg') }}" alt="">
                                </div>
                                <div class="media-body">
                ...
                <div class="dropdown az-profile-menu">
                    <a href="" class="az-img-user"><img
                            src="{{ asset('assets/dashboard/img/faces/face1.jpg') }}" alt=""></a>
                    <div class="dropdown-menu">
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="card card-dashboard-five">
                                    <div class="card-header">
                                        ...
                                        <span class="card-text"> A session is the period time a user is actively
                                            engaged with your website, app, etc.</span>
                                    </div><!-- card-header -->
                                    <div class="card-body row row-sm">
                                        <div class="col-6 d-sm-flex align-items-center">
